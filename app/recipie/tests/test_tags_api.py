...
class PrivateTagsApiTest(TestCase):
    ...
    def test_tags_limited_to_user(self):
        ...
        Tag.objects.create(user=user2,name='Fruity') #Tag for new user no need to assign to a variable
    ...
    def test_update_tag(self):
        """Test updating a tag"""
        tag=Tag.objects.create(user=self.user,name='After Dinner Cigars')
        payload={
            'name':'Dessert'
        }
    ...
    def test_filter_tags_assigned_to_recipies(self):
        """Test listing tags to those assigned to recipies"""
    ...
    def test_filtered_tags_unique(self):
        ...
        recipie1.tags.add(tag)
        recipie2.tags.add(tag)
